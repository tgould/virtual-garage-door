...
definition(
    ...
    namespace: "tgould",
    author: "Todd Gould",
    description: "Combine webIOPi/4 Relay Module with 3 Multi Sensors to monitor and control 3 garage doors. ",
...
def initialize() {
    ...
    //log.debug "initialize ... current state=  $realgdstate"
    //log.debug "initialize ... gd state= $virtualgd.currentContact"
